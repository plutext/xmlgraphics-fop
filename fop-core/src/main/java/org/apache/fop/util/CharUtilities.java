 ...
 * from Apache FOP 2.11: containsSurrogatePairAt raises IllegalArgumentException for a high surrogate at the end
 * of the sequence. See README.md, "Changes from Apache FOP 2.11". */
